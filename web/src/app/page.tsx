...
export default function Home() {
  return (
    <main className="grid min-h-screen grid-cols-2">
      ...
      overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] px-28 py-16"
      >
        {/* Blur */}
        ...
        {/* Sign In */}
        <a
          href={`https://github.com/login/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_GITHUB_IDNEXT_PUBLIC_GITHUB_ID}`}
